...
void APP_Initialize(void) {
    ...
    RPB9Rbits.RPB9R = 0b0101; // B9 is 0C3
     // put these initializations in APP_Initialize()
    ...
    switch (appData.state) {
        ...
        case APP_STATE_SCHEDULE_READ:
            ...
            if (appData.isReadComplete == true) {
                ...
                LATAbits.LATA1 = moto[0]; // direction
                OC1RS = moto[1]; // velocity, 50%
                LATBbits.LATB3 = moto[2]; // direction
                OC4RS = moto[3]; // velocity, 50%
                OC3RS = 1500+moto[4]*6000/180; // should set the motor to 90 degrees (0.5ms to 2.5ms is 1500 to 7500 for 0 to 180 degrees)
